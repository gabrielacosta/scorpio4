 ...
 * Time  : 7:51 PM
 */
public class SharingUX extends GridUX {

    public SharingUX(IQ iq) throws ConfigException, FactException {
//        Collection<Map<String,Object>> scripts = iq.getFactCloud().getCore().list(QUERY.ALL_SHARED_UX, iq.getConfiguration());
//        init(scripts);
